...
public:
    ...
    static void startRecording(std::vector<msr::airlib::VehicleCameraBase*> cameras, const msr::airlib::Kinematics::State* kinematics, const RecordingSettings& settings, std::vector <std::string> columns, VehiclePawnWrapper* wrapper);
