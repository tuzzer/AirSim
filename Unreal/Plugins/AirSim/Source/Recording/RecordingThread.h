...
public:
    ...
    static void startRecording(std::vector<msr::airlib::VehicleCameraBase*> cameras, std::vector<int> image_type_ids, const msr::airlib::Kinematics::State* kinematics, const RecordingSettings& settings, std::vector <std::string> columns);
